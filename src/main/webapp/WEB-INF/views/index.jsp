...
<%
    ...
    String sReturnUrl = "http://localhost:8088/checkplus_success";      // 성공시 이동될 URL
    String sErrorUrl = "http://localhost:8088/checkplus_fail";          // 실패시 이동될 URL
...
<%-- 	업체정보 암호화 데이타 : [<%= sEncData %>]<br><br> --%>
	...
	<form name="form_chk" method="post">
		<input type="text" name="m" value="checkplusService">						<!-- 필수 데이타로, 누락하시면 안됩니다. -->
		<input type="text" name="EncodeData" value="<%=sEncData%>">		<!-- 위에서 업체정보를 암호화 한 데이타입니다. -->
